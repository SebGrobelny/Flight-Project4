...
bool City::operator== (const City& city2)const
{
 ...
 //    cout << "YEE YEE";
//   cout << "OG City in comparison: " << name<< "\n";
//   cout << "Potential Airport City: "<< city2.name<<"\n"; 
    return (strcmp(name, city2.name) == 0) 
      && (strcmp(state, city2.state) == 0);
  
  if (airport[0] && city2.airport[0])
    //cout<< "These ain't equal";
...
ifstream& operator>> (ifstream &inf, City& city)
{
  char line[1000], *ptr;
  //City dummy; 
